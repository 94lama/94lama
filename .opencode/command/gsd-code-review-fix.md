...
<execution_context>
@/workspaces/94lama/.opencode/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/workspaces/94lama/.opencode/get-shit-done/workflows/code-review-fix.md end-to-end.
