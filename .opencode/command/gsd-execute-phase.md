...
<execution_context>
@/workspaces/94lama/.opencode/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/workspaces/94lama/.opencode/get-shit-done/workflows/execute-phase.md end-to-end.
