...
<execution_context>
@/workspaces/94lama/.opencode/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/workspaces/94lama/.opencode/get-shit-done/workflows/docs-update.md end-to-end.
