...
Intel system is disabled. To activate:
  ...
  node /workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs
