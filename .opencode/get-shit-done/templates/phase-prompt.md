...
<!-- For checkpoint task examples and patterns, see @/workspaces/94lama/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/workspaces/94lama/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/workspaces/94lama/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/workspaces/94lama/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
