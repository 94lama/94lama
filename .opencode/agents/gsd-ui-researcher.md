...
Use template from `/workspaces/94lama/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/workspaces/94lama/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
