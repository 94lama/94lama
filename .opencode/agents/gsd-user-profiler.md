...
<reference>
@/workspaces/94lama/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/workspaces/94lama/.opencode/get-shit-done/references/user-profiling.md` to load:
