...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspaces/94lama/.opencode
                  → checks /workspaces/94lama/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspaces/94lama/.opencode/get-shit-done
                  → writes to /workspaces/94lama/.opencode/get-shit-done/hooks/
...
@/workspaces/94lama/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/workspaces/94lama/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/workspaces/94lama/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
